...
public class BuyService extends AbstractSpecificationElementService<BuyDTO, BuyEntity> {
	
	@Autowired
	public BuyService(			
			@Qualifier(value = "BuyRepository") BaseRepositoryWithSpecification<BuyEntity> repository,
