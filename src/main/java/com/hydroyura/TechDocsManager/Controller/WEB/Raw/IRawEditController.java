...
public interface IRawEditController<DTO> {
	...
	public String editListAdd1POSTSave(@ModelAttribute(name = "dto") DTO dto, @ModelAttribute(name = "typeId") long typeId, RedirectAttributes redirectAttributes);
