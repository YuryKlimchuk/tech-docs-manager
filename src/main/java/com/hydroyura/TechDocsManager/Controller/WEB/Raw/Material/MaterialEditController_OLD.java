...
public class MaterialEditController_OLD extends AbstractRawEditController<MaterialDTO, MaterialEntity, MaterialTypeDTO, MaterialTypeEntity> {

	
	@Autowired
	public MaterialEditController_OLD(
