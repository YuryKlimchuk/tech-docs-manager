...
@Component(value = "BuyConverter")
public class BuyConverter implements IConverter<BuyEntity, BuyDTO> {

	@Override
	public BuyEntity convertFromDtoToEntity(BuyDTO dto) {
		...
		if(dto.getPdf() != null) {
			...
			String fileName = "./src/main/resources/static/draw/pdf/" + dto.getName() + "_"  + dto.getNumber() + "_" + dto.getManufacturer() + ".pdf";
	...
	@Override
	public BuyDTO convertFromEntityToDto(BuyEntity entity) {
