...
@Repository(value = "AssemblyAssemblyRateBaseRepository")
public interface AssemblyAssemblyRateBaseRepository extends JpaRepository<AssemblyAssemblyRateEntity, Long> {}
